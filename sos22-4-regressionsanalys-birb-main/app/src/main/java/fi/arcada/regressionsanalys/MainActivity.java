...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)  {
        ...
        regline = new RegressionLine(xData, yData);

        // Här kommer som vanligt alla findViewById som behövs

        findViewById(R.id.TextView);
        xSvar = findViewById(R.id.textView);
        corre = findViewById(R.id.textView2);
    ...
    public void getEstimate(View view) {
        ...
        double corSvar = regline.correlationCoefficient;
        System.out.println(yValue);

        xSvar.setText(String.format("Storlek: " + "%.2f", svar ));
        corre.setText(String.format("Korrelationskoeficient: " + "%.2f", corSvar));
